...
import 'package:att_school/features/school/master/semester/update/presentation/update_semester_screen.dart';
            ...
            AppScreen(
              ...
              children: [
                ...
                AppButton(
                  ...
                  onPressed: () async {
                    await Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return UpdateSemesterScreen(provider.data?.id! ?? '');
                        },
                      ),
                    );
                ...
                if (detail != null)
                  AppSection(
                    children: [
                      AppField('Semester', value: detail.name),
                      AppField('Tahun Akademik', value: detail.academicYearName),
                      AppField(
                        'Tanggal Mulai',
